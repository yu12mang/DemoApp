...
public class MediaPlayer {
  ...
  static {
    ...
    if(VERSION.SDK_INT > 23) {
      ...
      Log.e("com.sl.smartdvr   ",LIB_ROOT);
    try {
    ...
    loadFFmpeg_native_lib( LIB_ROOT , "libffmpeg.so");    
      ...
      if (!vvo_loaded) {
        ...
        Log.d("shenMedia","FALLBACK TO VVO JNI " + vvo_loaded);
      }
      loadVAO_native_lib( LIB_ROOT ,  "libvao.0.so");
    } catch (java.lang.UnsatisfiedLinkError e) {
      Log.e("shenMedia","Error loading libs", e);
    }
  }
  ...
  private SparseArray<MediaFormat> parseTrackInfo(byte[] tracks, String encoding) {
    ...
    try {
      ...
      Log.e("shenMedia","getTrackMap exception");
...
//	  Log.e("  ffff mediaplayer audiotrackinit start .  sampleRateInHz:=" + sampleRateInHz + " channels:=" + channels );
	    ...
	    try {
	      ...
	      Log.e("shenMedia","audioTrackInit", e);
	    }
  ...
  private void surfaceRender() {
    synchronized (this) {
      ...
      try {
        ...
        Log.e("shenMedia","surfaceRender", e);
      }
    }
  }
...
//        //Log.i("MiuiVideo: get message after player released, msg type: " + msg.what);
      ...
      switch (msg.what) {
        ...
        case MEDIA_SET_VIDEO_SIZE:
          ...
          return;
        case MEDIA_ERROR:
          Log.e("shenMedia","Error ("+msg.arg1+","+msg.arg2+")");
          ...
          return;
        case MEDIA_INFO:
          Log.i("shenMedia","Info ("+msg.arg1+","+msg.arg2+")");
          if (mOnInfoListener != null)
            mOnInfoListener.onInfo(mMediaPlayer, msg.arg1, msg.arg2);
          return;
        case MEDIA_CACHE:
        ...
        case MEDIA_HW_ERROR:
        	...
        	return;
        default:
          Log.e("shenMedia","Unknown message type " + msg.what);
          return;
      }
    }
  }
