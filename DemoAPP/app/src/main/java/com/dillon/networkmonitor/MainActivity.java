...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (permission != PackageManager.PERMISSION_GRANTED) {
            //需不需要解释的dialog
//            if (mLocalView.shouldRequest()) return;
            //请求权限
            ActivityCompat.requestPermissions((Activity)MainActivity.this, new String[]{Manifest.permission.ACCESS_COARSE_LOCATION}, 1);
        }
...
//            if (mLocalView.shouldRequest()) return;
            //请求权限
            ActivityCompat.requestPermissions((Activity)MainActivity.this, new String[]{Manifest.permission.READ_PHONE_STATE}, 1);
        }
