...
public class Main2Activity extends AppCompatActivity implements IVLCVout.Callback, Handler.Callback, SurfaceHolder.Callback {
...
//    private String mMediaUrl= "http://www.modrails.com/videos/passenger_nginx.mov";
...
//        mAudioManger = (AudioManager) getSystemService(Context.AUDIO_SERVICE);//音频控制器
        ...
        mSurfaceView.setVideoPath(mMediaUrl);
        mSurfaceView.start();
...
//        createPlayer(mMediaUrl);
    ...
    private static class MyPlayerListener implements MediaPlayer.EventListener {
        ...
        private WeakReference<Main2Activity> mOwner;

        public MyPlayerListener(Main2Activity owner) {
            mOwner = new WeakReference<>(owner);
        }

        @Override
        public void onEvent(MediaPlayer.Event event) {
            Main2Activity player = mOwner.get();
            switch (event.type) {
